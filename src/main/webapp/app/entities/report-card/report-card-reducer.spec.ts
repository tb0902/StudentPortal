...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTCARD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REPORTCARD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REPORTCARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REPORTCARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REPORTCARD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REPORTCARD actions', async () => {
      const arg = 42666;
